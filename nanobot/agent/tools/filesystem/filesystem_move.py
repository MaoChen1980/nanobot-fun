...
class MoveFileTool(_FsTool):
    ...
    name = "move_file"
    description = (
        "Move or rename a file. Safer than exec mv — workspace-guarded and single-file only.\n"
        "Framework auto-verifies: source exists, source is a file, destination does not already exist.\n"
        "Auto-confirms both files after execution (source gone, destination created)."
    )
